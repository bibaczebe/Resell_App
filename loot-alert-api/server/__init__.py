...
def create_app() -> Flask:
    ...
    def debug_scrape():
        ...
        from server.scrapers import olx, vinted, allegro, ebay, reverb, discogs, random_headers
        ...
        for name, module in (("olx", olx), ("vinted", vinted), ("allegro", allegro), ("ebay", ebay), ("reverb", reverb), ("discogs", discogs)):
            try:
