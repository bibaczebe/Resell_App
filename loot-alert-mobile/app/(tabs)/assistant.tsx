...
const styles = StyleSheet.create({
  ...
  starters: { padding: 20, gap: 10 },
  startersLabel: { color: Colors.textMuted, fontSize: 13, marginBottom: 4 },
  starter: { backgroundColor: Colors.surface, borderRadius: 12, borderWidth: 1, borderColor: Colors.border, padding: 14 },
  starterText: { color: Colors.text, fontSize: 14, lineHeight: 20 },
